...
| `pcb_render_inspection_svg` | Return whole-board or local SVG with readable component and pin/net labels. Bottom observation mirrors geometry once, keeping annotation text readable. outputPath optional. | target, bridgeUrl, outputPath, units, region, side, layers, nets, pinLabels |
